    ...
    <div className="gh">
      ...
      <div className="gh_body">
        <div className="matric_title">Schedule Advisor Meeting</div>
         <div className="matric_body"> Please schedule a meeting with the advisor that is assigned to the first letter of your LAST name by clicking their name</div>
