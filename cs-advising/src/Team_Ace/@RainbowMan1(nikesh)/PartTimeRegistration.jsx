...
import "./PartTimeRegistration.css";
  ...
  return (
    <>
      ...
      <header className="mh">
        ...
        <p>
          Students with F-1 and J-1 immigration status are required by U.S.
          immigration regulations to maintain full-time registration status for
          the duration of their academic programs. Full-time status is defined
          as registration for a minimum of 12 credit hours for undergraduates
          and 9 credit hours for graduate students. However, these regulations
          allow students to register for less than full-time credit hours under
          limited circumstances, listed below. Your Dean or academic Advisor
          must recommend and approve the appropriate reason. Return the
          completed form to the Office of International Student Services so that
          the form may be processed by USCIS.
        </p>
      </header>
      <form
        className="pt-form"
      ...
      >
        ...
        <input
          {...register("semesterRequested")}
          placeholder="Semester Requested"
        />
